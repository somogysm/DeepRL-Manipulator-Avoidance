...
class DeepNAF(nn.Module):
    '''
    Implementation of a Deep NAF network, for more information regarding network structure and theory refer to: 
    Continuous Deep Q-Learning with Model-based Acceleration [arXiv:1603.00748v1]
    '''
    ...
    def forward(self, input_, action=None):
        """
        Foward propogation of network.

        input_ (tensor): Input tensor describing current environment state.
        """
